...
export default function ListMedicalPage() {
  ...
  // redux state
  const { activeLMOsList, loading, error } = useAppSelector(
  ...
  const lmoListData: DoctorDashboardLMO[] = Array.isArray(activeLMOsList)
    ? activeLMOsList
    : [];
  console.log(activeLMOsList);
