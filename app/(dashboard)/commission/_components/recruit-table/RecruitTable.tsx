              ...
              <TableRow key={headerGroup.id}>
                {headerGroup.headers.map((header) => (
                  <TableHead
                    ...
                    className="py-2.5 px-3 truncate text-ellipsis font-medium text-left whitespace-nowrap cursor-pointer select-none border-b border-gray-200 bg-[--primary-30] text-black"
                  >
                    {flexRender(
