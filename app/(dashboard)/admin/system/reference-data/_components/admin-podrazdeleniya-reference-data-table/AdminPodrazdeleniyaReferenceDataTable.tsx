...
interface AdminPodrazdeleniyeReferenceDataTableProps {
  data: Podrazdeleniye[];
}

export const AdminPodrazdeleniyeReferenceDataTable: React.FC<
  AdminPodrazdeleniyeReferenceDataTableProps
> = ({ data }) => {
